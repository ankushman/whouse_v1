  ...
  return (
    <div className="space-y-4 p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
        {/* 30-day spend trend */}
        <Card className="hover-lift-sm po-chart-enter">
      ...
      {/* Master Table Card */}
      <Card className="hover-lift-sm po-table-card">
        <CardHeader className="pb-3">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button size="sm" className="press-scale h-9" onClick={handleNewPO}>
        ...
        <SheetFooter className="border-t bg-muted/30 px-4 py-3">
          <div className="flex w-full items-center justify-between gap-2">
            ...
            <div className="flex gap-1.5">
              ...
              {po.status === "approved" && (
                <Button size="sm" className="press-scale h-8" onClick={handleAck}>
              ...
              {!["draft", "pending-approval", "approved", "acknowledged"].includes(po.status) && (
                <Button variant="outline" size="sm" className="press-scale btn-outline-animate h-8" onClick={handleAck}>
...
function OverviewTab({ po, receiptProgress, paymentProgress, leadTimeVariance }: {
  ...
  return (
    <div className="space-y-3">
      ...
      <Card className="hover-lift-sm po-card-enter">
        <CardHeader className="pb-2">
      ...
      <div className="po-card-enter grid gap-3 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="inner-glow glass-subtle space-y-2 pt-0">
      ...
      {/* Notes */}
      {po.notes && (
        <Card className="hover-lift-sm po-card-enter bg-amber-50/50 dark:bg-amber-950/20">
          <CardContent className="inner-glow glass-subtle p-3">
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 gap-2">
        <Card className="hover-lift-sm po-stat-enter">
