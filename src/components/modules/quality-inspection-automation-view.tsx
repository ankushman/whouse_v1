      ...
      <div className="qia-drawer-panel">
        ...
        <div className="qia-drawer-body">
          ...
          <div className="qia-drawer-actions">
            <Button size="sm" className="qia-btn-primary"><Eye size={14} /> View Images</Button>
    ...
    <>
      ...
      <div className="qia-drawer-panel">
        ...
        <div className="qia-drawer-body">
          ...
          <div className="qia-drawer-actions">
            <Button size="sm" className="qia-btn-primary"><RefreshCw size={14} /> Calibrate</Button>
    ...
    <>
      ...
      <div className="qia-drawer-panel">
        ...
        <div className="qia-drawer-body">
          ...
          <div className="qia-drawer-actions">
            <Button size="sm" className="qia-btn-primary"><RefreshCw size={14} /> Retrain</Button>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="0" className="qia-tab-content">
          ...
          <div className="qia-chart-grid">
            ...
            <Card className="qia-chart-card"><CardHeader className="qia-chart-header"><CardTitle className="qia-chart-title">Severity Distribution</CardTitle></CardHeader><CardContent><ResponsiveContainer width="100%" height={280}><PieChart><Pie data={data.severityDist} dataKey="count" nameKey="severity" cx="50%" cy="50%" outerRadius={90} innerRadius={50} paddingAngle={3} label={({ severity, count }) => `${severity}: ${count}`}><Cell fill="#dc2626" /><Cell fill="#f59e0b" /><Cell fill="#6366f1" /><Cell fill="#94a3b8" /></Pie><Tooltip /><Legend wrapperStyle={{ fontSize: 12 }} /></PieChart></ResponsiveContainer></CardContent></Card>
          </div>
          <div className="qia-chart-grid">
            <Card className="qia-chart-card"><CardHeader className="qia-chart-header"><CardTitle className="qia-chart-title">Defect Types</CardTitle></CardHeader><CardContent><ResponsiveContainer width="100%" height={280}><BarChart data={data.defectTypeDist}><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis dataKey="type" tick={{ fontSize: 10 }} angle={-20} textAnchor="end" height={55} /><YAxis tick={{ fontSize: 12 }} /><Tooltip contentStyle={{ borderRadius: 8 }} /><Bar dataKey="count" radius={[4, 4, 0, 0]}>{data.defectTypeDist.map((entry, i) => <Cell key={i} fill={entry.color} />)}</Bar></BarChart></ResponsiveContainer></CardContent></Card>
            <Card className="qia-chart-card"><CardHeader className="qia-chart-header"><CardTitle className="qia-chart-title">AI vs Manual Comparison</CardTitle></CardHeader><CardContent><ResponsiveContainer width="100%" height={280}><BarChart data={data.aiVsManual} layout="vertical"><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis type="number" tick={{ fontSize: 12 }} /><YAxis dataKey="metric" type="category" tick={{ fontSize: 11 }} width={110} /><Tooltip contentStyle={{ borderRadius: 8 }} /><Legend wrapperStyle={{ fontSize: 12 }} /><Bar dataKey="ai" fill="#0d9488" name="AI" radius={[0, 4, 4, 0]} /><Bar dataKey="manual" fill="#94a3b8" name="Manual" radius={[0, 4, 4, 0]} /></BarChart></ResponsiveContainer></CardContent></Card>
          </div>
          <div className="qia-chart-grid">
            <Card className="qia-chart-card qia-chart-wide"><CardHeader className="qia-chart-header"><CardTitle className="qia-chart-title">Labor Savings &amp; Defect Prevention Trend</CardTitle></CardHeader><CardContent><ResponsiveContainer width="100%" height={260}><AreaChart data={data.monthlyTrend}><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis dataKey="month" tick={{ fontSize: 12 }} /><YAxis tick={{ fontSize: 12 }} /><Tooltip contentStyle={{ borderRadius: 8 }} /><Legend wrapperStyle={{ fontSize: 12 }} /><Area type="monotone" dataKey="laborSaved" stroke="#0d9488" fill="#ccfbf1" strokeWidth={2} name="Labor Saved (₹)" /><Area type="monotone" dataKey="defectsFound" stroke="#e11d48" fill="#fee2e2" strokeWidth={2} name="Defects Found" /></AreaChart></ResponsiveContainer></CardContent></Card>
            <Card className="qia-chart-card"><CardHeader className="qia-chart-header"><CardTitle className="qia-chart-title">Warehouse Accuracy</CardTitle></CardHeader><CardContent><ResponsiveContainer width="100%" height={260}><BarChart data={data.warehouseAccuracy}><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis dataKey="warehouse" tick={{ fontSize: 9 }} angle={-25} textAnchor="end" height={50} /><YAxis domain={[85, 100]} tick={{ fontSize: 12 }} /><Tooltip contentStyle={{ borderRadius: 8 }} /><Bar dataKey="accuracy" radius={[4, 4, 0, 0]} fill="#0d9488" /></BarChart></ResponsiveContainer></CardContent></Card>
          </div>
        </TabsContent>
