...
export default function MolybdenumSulfideLogisticsView() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="p-2 rounded-lg" style={{ backgroundColor: '#0f766e22' }}>
          <Copy className="w-5 h-5" style={{ color: '#0f766e' }} />
        </div>
        <div>
          <h2 className="text-xl font-bold">Molybdenum Sulfide Logistics</h2>
          <p className="text-sm text-gray-400">MoS2 solid lubricant &#8226; Semiconductor 2D TMD &#8226; Submarine bearing &#8226; Aerospace dry film supply chain</p>
        </div>
      </div>
