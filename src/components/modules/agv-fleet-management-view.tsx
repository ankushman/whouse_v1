      ...
      <Tabs defaultValue="0">
        ...
        <TabsContent value="1" className="space-y-4 mt-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => { setAgvSortDir(agvSortDir === "asc" ? "desc" : "asc"); }}><ArrowUpDown className="h-3.5 w-3.5 mr-1" />{agvSortDir === "asc" ? "ASC" : "DESC"}</Button>
        ...
        <TabsContent value="3" className="space-y-4 mt-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <Card key={k.label}><CardContent className="p-3"><p className="text-[10px] text-slate-500">{k.label}</p><p className={cn("text-lg font-bold", k.color)}>{k.value}</p></CardContent></Card>
            ))}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Card>
        ...
        <TabsContent value="5" className="space-y-6 mt-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <Card key={k.label}>
                <CardContent className="p-3"><p className="text-[10px] text-slate-500">{k.label}</p><p className={cn("text-lg font-bold", k.color)}>{k.value}</p></CardContent>
              </Card>
            ))}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {drawerTab === "agv" && drawerRecord && (
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.success("Dispatched", `${drawerRecord.id} has been dispatched`); setDrawerOpen(false); }}><Play className="h-3.5 w-3.5 mr-1" />Dispatch</Button>
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.info("Charging", `${drawerRecord.id} sent to charging station`); setDrawerOpen(false); }}><Zap className="h-3.5 w-3.5 mr-1" />Charge</Button>
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.warning("Maintenance", `${drawerRecord.id} flagged for maintenance`); setDrawerOpen(false); }}><Wrench className="h-3.5 w-3.5 mr-1" />Maintain</Button>
                </div>
              </div>
            )}
            ...
            {drawerTab === "mission" && drawerRecord && (
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.info("Mission Paused", `${drawerRecord.id} has been paused`); setDrawerOpen(false); }}><Pause className="h-3.5 w-3.5 mr-1" />Pause</Button>
            ...
            {drawerTab === "maint" && drawerRecord && (
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.info("Updated", `Maintenance ${drawerRecord.id} updated`); setDrawerOpen(false); }}><RefreshCw className="h-3.5 w-3.5 mr-1" />Update</Button>
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.warning("Escalated", `Maintenance ${drawerRecord.id} escalated`); setDrawerOpen(false); }}><AlertTriangle className="h-3.5 w-3.5 mr-1" />Escalate</Button>
                </div>
              </div>
            )}
          </>
