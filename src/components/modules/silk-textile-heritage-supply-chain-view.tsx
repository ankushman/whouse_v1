...
const genRecords = (offset: number) =>
  Array.from({ length: 20 }, (_, i) => ({
    id: `STH-${String(offset + i + 1).padStart(4, '0')}`,
...
const silkRecords = [
  { id: 'STH-0001', painter: 'Varanasi Silk Weavers UP', ware: 'Banarasi Silk Brocade Saree', status: 'GI Silk Mark Certified', qty: 5, cost: 48000, date: '2024-01-18' },
  { id: 'STH-0002', painter: 'Kanchipuram Silk Guild TN', ware: 'Kanchipuram Temple Silk Saree', status: 'IS 17183 Silk Grade A', qty: 4, cost: 42000, date: '2024-01-31' },
  { id: 'STH-0003', painter: 'Sualkuchi Muga Cluster Assam', ware: 'Muga Silk Mekhela Chador', status: 'Acid-Free Tissue Wrap Pack', qty: 8, cost: 18000, date: '2024-02-13' },
  { id: 'STH-0004', painter: 'Patan Patola Weavers Gujarat', ware: 'Patola Double Ikat Saree', status: 'Palletised Air Transit', qty: 6, cost: 14000, date: '2024-02-25' },
  { id: 'STH-0005', painter: 'Chanderi Silk Weavers MP', ware: 'Chanderi Silk Muslin Dupatta', status: 'Climate Vault 20-24C', qty: 10, cost: 8000, date: '2024-03-10' },
  { id: 'STH-0006', painter: 'Bhagalpur Tussar Society Bihar', ware: 'Bhagalpuri Tussar Silk Stole', status: 'Silk Denier Tensile QC', qty: 3, cost: 50000, date: '2024-03-23' },
  { id: 'STH-0007', painter: 'Sambalpur Ikat Cooperative Odisha', ware: 'Sambalpuri Ikat Silk Fabric', status: 'GI Silk Mark Certified', qty: 6, cost: 16000, date: '2024-04-05' },
  { id: 'STH-0008', painter: 'Bishnupur Baluchari Weavers WB', ware: 'Baluchari Silk Pallu Saree', status: 'IS 17183 Silk Grade A', qty: 12, cost: 6000, date: '2024-04-18' },
  { id: 'STH-0009', painter: 'Varanasi Silk Weavers UP', ware: 'Kanchipuram Temple Silk Saree', status: 'Acid-Free Tissue Wrap Pack', qty: 4, cost: 44000, date: '2024-05-01' },
  { id: 'STH-0010', painter: 'Kanchipuram Silk Guild TN', ware: 'Banarasi Silk Brocade Saree', status: 'Palletised Air Transit', qty: 5, cost: 46000, date: '2024-05-13' },
  { id: 'STH-0011', painter: 'Sualkuchi Muga Cluster Assam', ware: 'Muga Silk Mekhela Chador', status: 'Climate Vault 20-24C', qty: 8, cost: 20000, date: '2024-05-25' },
  { id: 'STH-0012', painter: 'Patan Patola Weavers Gujarat', ware: 'Patola Double Ikat Saree', status: 'Silk Denier Tensile QC', qty: 6, cost: 12000, date: '2024-06-07' },
  { id: 'STH-0013', painter: 'Chanderi Silk Weavers MP', ware: 'Chanderi Silk Muslin Dupatta', status: 'GI Silk Mark Certified', qty: 10, cost: 10000, date: '2024-06-19' },
  { id: 'STH-0014', painter: 'Bhagalpur Tussar Society Bihar', ware: 'Bhagalpuri Tussar Silk Stole', status: 'IS 17183 Silk Grade A', qty: 3, cost: 52000, date: '2024-07-01' },
  { id: 'STH-0015', painter: 'Sambalpur Ikat Cooperative Odisha', ware: 'Sambalpuri Ikat Silk Fabric', status: 'Acid-Free Tissue Wrap Pack', qty: 7, cost: 18000, date: '2024-07-13' },
  { id: 'STH-0016', painter: 'Bishnupur Baluchari Weavers WB', ware: 'Baluchari Silk Pallu Saree', status: 'Palletised Air Transit', qty: 15, cost: 5000, date: '2024-07-25' },
  { id: 'STH-0017', painter: 'Varanasi Silk Weavers UP', ware: 'Banarasi Silk Brocade Saree', status: 'Climate Vault 20-24C', qty: 4, cost: 44000, date: '2024-08-07' },
  { id: 'STH-0018', painter: 'Kanchipuram Silk Guild TN', ware: 'Kanchipuram Temple Silk Saree', status: 'Silk Denier Tensile QC', qty: 5, cost: 40000, date: '2024-08-19' },
  { id: 'STH-0019', painter: 'Sualkuchi Muga Cluster Assam', ware: 'Muga Silk Mekhela Chador', status: 'GI Silk Mark Certified', qty: 8, cost: 22000, date: '2024-08-31' },
  { id: 'STH-0020', painter: 'Patan Patola Weavers Gujarat', ware: 'Patola Double Ikat Saree', status: 'IS 17183 Silk Grade A', qty: 6, cost: 14000, date: '2024-09-12' },
]
...
export default function SilkTextileHeritageSupplyChainView() {
  ...
  return (
    <div className="sth-root space-y-6 p-6">
      <ModuleBreadcrumb items={[{ label: 'Logistics' }, { label: 'Silk Heritage' }]} />
      <PageHeader title="Silk & Textile Heritage Supply Chain" description="Indian heritage silk and textile supply chain with IS 17183 silk certification, silk denier tensile quality control, acid-free tissue wrap packaging, and GI Silk Mark across 8 weaving communities in Varanasi, Kanchipuram, and Sualkuchi" />
      <Tabs defaultValue="dashboard" className="space-y-6">
        ...
        <TabsContent value="shipments" className="space-y-6">
          <SearchFilterToolbar
            ...
            onRefresh={() => {}}
            placeholder="Search silk textile shipments..."
          />
        ...
        <TabsContent value="insights" className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <Card>
              <CardHeader><CardTitle>Indian Heritage Silk — 5000-Year Vedic Era Silk Weaving Tradition</CardTitle></CardHeader>
            ...
            <Card>
              <CardHeader><CardTitle>IS 17183 Silk Standards & Denier Tensile Quality Control</CardTitle></CardHeader>
            ...
            <Card>
              <CardHeader><CardTitle>Acid-Free Tissue Wrap Packaging for Heritage Silk Transit</CardTitle></CardHeader>
            ...
            <Card>
              <CardHeader><CardTitle>AI Jacquard Design Verification & Silk Heritage Market Development</CardTitle></CardHeader>
