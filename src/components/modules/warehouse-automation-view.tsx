        ...
        <TabsContent value="3" className="space-y-4 mt-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <Card key={k.label}><CardContent className="p-3"><p className="text-[10px] text-slate-500 dark:text-slate-400">{k.label}</p><p className={cn("text-lg font-bold", k.color)}>{k.value}</p></CardContent></Card>
            ))}
          </div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            {sheetRobot && (
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.info("Charging", `${sheetRobot.id} sent to charging station`) }}>
                    <Zap className="h-3.5 w-3.5 mr-1" />Charge
                  </Button>
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => { toast.warning("Maintenance", `${sheetRobot.id} flagged for maintenance`) }}>
