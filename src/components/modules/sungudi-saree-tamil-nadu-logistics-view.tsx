...
const StatusBadge = ({ status }: { status: string }) => (
  <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-fuchsia-100 text-fuchsia-800">{status}</span>
)

const CostBar = ({ cost, max }: { cost: number; max: number }) => (
  <div className="w-24 h-2 bg-fuchsia-200 rounded-full overflow-hidden"><div className="h-full bg-fuchsia-700 rounded-full" style={{ width: `${ri(0, 100, (cost / max) * 100)}%` }} /></div>
)
...
const genRecords = (offset: number) =>
  Array.from({ length: 20 }, (_, i) => ({
    id: `SGS-${String(offset + i + 1).padStart(4, '0')}`,
...
const sungudiRecords = [
  { id: 'SGS-0001', painter: 'Madurai Sungudi Weavers Guild TN', ware: 'Sungudi Traditional Saree', status: 'GI Tamil Nadu Sungudi Mark', qty: 5, cost: 48000, date: '2024-01-18' },
  { id: 'SGS-0002', painter: 'Sivaganga Sungudi Cluster TN', ware: 'Sungudi Temple Border Saree', status: 'IS 16796 Sungudi Weave Grade A', qty: 4, cost: 42000, date: '2024-01-31' },
  { id: 'SGS-0003', painter: 'Chellampatti Block Print Society', ware: 'Sungudi Madurai Weave Stole', status: 'Muslin Cloth Fold Pack', qty: 8, cost: 18000, date: '2024-02-13' },
  { id: 'SGS-0004', painter: 'Virudhunagar Sungudi Cooperative TN', ware: 'Sungudi Dot Design Dupatta', status: 'Palletised Truck Transit', qty: 6, cost: 14000, date: '2024-02-25' },
  { id: 'SGS-0005', painter: 'Ramanathapuram Weaving Centre', ware: 'Sungudi Festival Cotton Wrap', status: 'Dry Storage 20-28C', qty: 10, cost: 8000, date: '2024-03-10' },
  { id: 'SGS-0006', painter: 'Dindigul Sungudi Artisan Group', ware: 'Sungudi Bridal Koorai Saree', status: 'Cotton Yarn Tensile QC', qty: 3, cost: 50000, date: '2024-03-23' },
  { id: 'SGS-0007', painter: 'Theni Handloom Society TN', ware: 'Sungudi Geometric Border Stole', status: 'GI Tamil Nadu Sungudi Mark', qty: 6, cost: 16000, date: '2024-04-05' },
  { id: 'SGS-0008', painter: 'Paramakudi Sungudi Women Collective', ware: 'Sungudi Cotton Handkerchief Set', status: 'IS 16796 Sungudi Weave Grade A', qty: 12, cost: 6000, date: '2024-04-18' },
  { id: 'SGS-0009', painter: 'Madurai Sungudi Weavers Guild TN', ware: 'Sungudi Temple Border Saree', status: 'Muslin Cloth Fold Pack', qty: 4, cost: 44000, date: '2024-05-01' },
  { id: 'SGS-0010', painter: 'Sivaganga Sungudi Cluster TN', ware: 'Sungudi Traditional Saree', status: 'Palletised Truck Transit', qty: 5, cost: 46000, date: '2024-05-13' },
  { id: 'SGS-0011', painter: 'Chellampatti Block Print Society', ware: 'Sungudi Madurai Weave Stole', status: 'Dry Storage 20-28C', qty: 8, cost: 20000, date: '2024-05-25' },
  { id: 'SGS-0012', painter: 'Virudhunagar Sungudi Cooperative TN', ware: 'Sungudi Dot Design Dupatta', status: 'Cotton Yarn Tensile QC', qty: 6, cost: 12000, date: '2024-06-07' },
  { id: 'SGS-0013', painter: 'Ramanathapuram Weaving Centre', ware: 'Sungudi Festival Cotton Wrap', status: 'GI Tamil Nadu Sungudi Mark', qty: 10, cost: 10000, date: '2024-06-19' },
  { id: 'SGS-0014', painter: 'Dindigul Sungudi Artisan Group', ware: 'Sungudi Bridal Koorai Saree', status: 'IS 16796 Sungudi Weave Grade A', qty: 3, cost: 52000, date: '2024-07-01' },
  { id: 'SGS-0015', painter: 'Theni Handloom Society TN', ware: 'Sungudi Geometric Border Stole', status: 'Muslin Cloth Fold Pack', qty: 7, cost: 18000, date: '2024-07-13' },
  { id: 'SGS-0016', painter: 'Paramakudi Sungudi Women Collective', ware: 'Sungudi Cotton Handkerchief Set', status: 'Palletised Truck Transit', qty: 15, cost: 5000, date: '2024-07-25' },
  { id: 'SGS-0017', painter: 'Madurai Sungudi Weavers Guild TN', ware: 'Sungudi Traditional Saree', status: 'Dry Storage 20-28C', qty: 4, cost: 44000, date: '2024-08-07' },
  { id: 'SGS-0018', painter: 'Sivaganga Sungudi Cluster TN', ware: 'Sungudi Temple Border Saree', status: 'Cotton Yarn Tensile QC', qty: 5, cost: 40000, date: '2024-08-19' },
  { id: 'SGS-0019', painter: 'Chellampatti Block Print Society', ware: 'Sungudi Madurai Weave Stole', status: 'GI Tamil Nadu Sungudi Mark', qty: 8, cost: 22000, date: '2024-08-31' },
  { id: 'SGS-0020', painter: 'Virudhunagar Sungudi Cooperative TN', ware: 'Sungudi Dot Design Dupatta', status: 'IS 16796 Sungudi Weave Grade A', qty: 6, cost: 14000, date: '2024-09-12' },
]

export default function SungudiSareeTamilNaduLogisticsView() {
  const [tab, setTab] = useState('dashboard')
  const [searchQuery, setSearchQuery] = useState('')
  const [activeFilters, setActiveFilters] = useState<Record<string, string[]>>({})

  const allRecords = [...sungudiRecords, ...genRecords(21), ...genRecords(41)]
  ...
  return (
    <div className="sgs-root space-y-6 p-6">
      <ModuleBreadcrumb items={[{ label: 'Logistics' }, { label: 'Sungudi Saree TN' }]} />
      <PageHeader title="Sungudi Saree Tamil Nadu Logistics" description="Tamil Nadu Sungudi cotton saree and tie-dye textile supply chain with IS 16796 certification, cotton yarn tensile QC, muslin cloth fold packaging, and GI Tamil Nadu Sungudi Mark across 8 weaving communities in Madurai, Sivaganga, and Virudhunagar" />
      <Tabs defaultValue="dashboard" className="space-y-6">
        <TabsList className="bg-fuchsia-100">
        ...
        <TabsContent value="shipments" className="space-y-6">
          <SearchFilterToolbar
            ...
            onRefresh={() => {}}
            placeholder="Search Sungudi saree shipments..."
          />
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {filteredRecords.map(record => (
                  <tr key={record.id} className="border-t hover:bg-fuchsia-50/50">
        ...
        <TabsContent value="insights" className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <Card>
              <CardHeader><CardTitle>Sungudi Saree — 1400-Year Madurai Tamil Nadu Tie-Dye Cotton Textile Heritage</CardTitle></CardHeader>
            ...
            <Card>
              <CardHeader><CardTitle>IS 16796 Sungudi Weave Standards & Cotton Yarn Tensile QC</CardTitle></CardHeader>
            ...
            <Card>
              <CardHeader><CardTitle>Muslin Cloth Fold Packaging for Sungudi Saree Transit</CardTitle></CardHeader>
            ...
            <Card>
              <CardHeader><CardTitle>AI Pattern Verification & Sungudi Heritage Market Development</CardTitle></CardHeader>
