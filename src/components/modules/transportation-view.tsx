    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6 stagger-children">
        {[
          ...
          <Card key={item.label} className="hover-lift-sm card-depth card-shine hover-scale-sm rounded-xl border-border/60 shadow-sm">
      ...
      {delayedVehicles.length > 0 && (
        <Card className="hover-lift-sm rounded-xl border-red-200 bg-red-50/50 dark:border-red-900 dark:bg-red-950/30 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              <AlertTriangle className="h-4 w-4 text-red-600 dark:text-red-400" />
              <CardTitle className="text-sm font-semibold text-red-700 dark:text-red-300">Delayed Deliveries</CardTitle>
              <Badge variant="destructive" className="badge-interactive text-[10px]">{delayedVehicles.length}</Badge>
            </div>
          </CardHeader>
          <CardContent>
