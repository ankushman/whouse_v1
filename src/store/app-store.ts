...
export const navItems: NavItem[] = [
  ...
  { id: 'carbon-capture-storage', label: 'Carbon Capture', icon: 'Flame', group: 'operations', roles: ['super_admin', 'executive', 'regional_manager', 'warehouse_manager', 'logistics', 'supervisor'] },
