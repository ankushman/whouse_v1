#!/usr/bin/env python3
"""Generate R397a: nickel-powder-logistics-view.tsx"""
...
with open('/home/z/my-project/src/components/modules/nickel-powder-logistics-view.tsx', 'w') as f:
    f.write(content)
print('nickel-powder OK')
