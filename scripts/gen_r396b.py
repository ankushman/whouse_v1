#!/usr/bin/env python3
"""Generate R396b: aluminium-bronze-logistics-view.tsx"""
...
with open('/home/z/my-project/src/components/modules/aluminium-bronze-logistics-view.tsx', 'w') as f:
    f.write(content)
print('aluminium-bronze OK')
