#!/usr/bin/env python3
"""Generate antimony-alloy-logistics-view.tsx (R405a)"""
...
import os
outpath = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'src', 'components', 'modules', 'antimony-alloy-logistics-view.tsx')
