#!/usr/bin/env python3
"""Generate kasuti-karnataka-logistics-view.tsx at exactly 253 lines."""
import textwrap
...
with open('/home/z/my-project/src/components/modules/kasuti-karnataka-logistics-view.tsx', 'w') as f:
    f.write(text)
print("Written kasuti-karnataka-logistics-view.tsx")
