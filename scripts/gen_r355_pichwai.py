...
# Pichwai Rajasthan Logistics - new module
# CSS prefix: pic-* | Color: #7e22ce purple (Pichwai devotional paintings)
...
lines = content.split('\n')
print(f"Lines before fix: {len(lines)}")
if len(lines) != 253:
...
print(f"Lines after fix: {len(lines)}")

outpath = '/home/z/my-project/src/components/modules/pichwai-rajasthan-logistics-view.tsx'
