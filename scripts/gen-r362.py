#!/usr/bin/env python3
"""Generate R362 modules: Kalamkari Pen Art AP (new) + Aerospace Parts (overwrite) at exactly 253 lines."""
...
# ============================================================
# MODULE 1: Kalamkari Pen Art Andhra Pradesh Logistics (NEW)
# ============================================================
kalamkari = '''import React, { useState, useMemo } from 'react'
...
# ============================================================
# MODULE 2: Aerospace Parts Tracking (OVERWRITE 234->253)
# ============================================================
aerospace = '''import React, { useState, useMemo } from 'react'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs'
import { PageHeader } from '@/components/shared/page-header'
import { SearchFilterToolbar } from '@/components/shared/search-filter-toolbar'
...
kalamkari_content = pad_to_253(kalamkari)
aerospace_content = pad_to_253(aerospace)

with open(f'{base}/kalamkari-pen-art-andhra-logistics-view.tsx', 'w') as f:
    f.write(kalamkari_content)
print(f"Kalamkari: {len(kalamkari_content.split(chr(10)))} lines")

with open(f'{base}/aerospace-parts-tracking-view.tsx', 'w') as f:
    f.write(aerospace_content)
print(f"Aerospace: {len(aerospace_content.split(chr(10)))} lines")
